...
一名深耕质量领域的测试从业者，始终对产品与技术保有强烈的好奇与探索欲。比起空泛的构想，更专注打磨可落地、高可靠的质量方案，在一次次测试验证中，坚守初心，稳步成长。

- 📖 不会写代码的测试不是一个好测试，喜欢代码创造万物的感觉
- 🚀 擅长将需求构想，转化为可执行、可落地的测试流程与用例
- ⚙️ 注重严谨的校验逻辑、优质的用户体验与稳定的产品交付
- 🧩 熟悉功能测试、兼容性校验、前后端联动质量把控，多维度开展测试工作
- 🌱 坚持长期沉淀积累，持续打磨测试思维，循序渐进提升专业能力
